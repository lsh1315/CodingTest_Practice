...
int main(){
    ...
    for (int t=0; t<k; t++){
        ...
        for(i=0; i<n; i++){
            for(j=0; j<n; j++){
                printf("%c%d ",'A'-1+map[i][j],energy[i][j]);     // check
            }
            printf("\n");
        }
        ...
        printf("T%d %d %d %d %d %d %d %d \n", t+1, RGB[7],RGB[4],RGB[5],RGB[6],RGB[1],RGB[2],RGB[3]);
    }
    printf("\n");
